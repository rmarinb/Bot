...
def envio_mensaje(usuario, con):
    ...
    cursor.execute("SELECT	u2.telefono FROM usuarios u,usuarios u2 WHERE u.id = 1 AND u.id_tutor = u2.id;")
...
driver_path = 'ruta/al/controlador/chromedriver.exe'
...
"""
Abre WhatsApp Web y escanea el código QR desde la página web que se abre automáticamente. Esto sincronizará tu sesión de WhatsApp en el controlador de Selenium.
"""
...
mensaje = '¡Hola! Este es un mensaje enviado automáticamente desde Python.'
